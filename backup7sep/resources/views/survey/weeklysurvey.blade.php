              ...
              <table class="table" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody class="card-body">
                 ...
                 <tr class="">
                  ...
                  <td>
                    <a href="" title=""><img src="{{ asset('public/icons/image/eye.png')}}" alt="" class="sideicon"></a>
                    <a href="{{url('surveyview/'.$row->id)}}" title=""><img src="{{ asset('public/icons/image/create1.png')}}" alt="" class="sideicon"></a>

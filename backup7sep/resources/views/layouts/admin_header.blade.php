                ...
                <div class="navbar-collapse" >
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item dropdown delnot" >
                            ...
                            <img src="{{url('public/images/notification.jpg')}}" alt="view" class="img-circle " style="height: 18px" > <span class="badge badge-light" id="notifyy" ></span><p></p>                                             
                            </a>
                            ...
                            <div class="dropdown-menu mailbox animated slideInUp" >
                                <ul>
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="{{url('notifications')}}">
                                                ...
                                                <!-- <span class="mail-desc">{{$row->title}}</span> -->
                                                 <span class="time">{{$row->time}}</span> </div>
                                            </a>
                                            @endforeach
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="{{url('markallunread')}}"> <strong>Mark As Unread</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="{{url('conversation/'.$row->intakeco_id)}}">
                                                 @if($row->image)
                                                <div class="user-img"> <img src="{{url('public/clients/'.$row->image)}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> 
                                                </div>
                                                @else
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark lbl3" href="{{url('inbox')}}" aria-expanded="false"><img src="{{ asset('public/icons/image/mail.png')}}" alt="" class="sideicon"><span class="hide-menu"> Inbox</span></a>
                         ...
                         <li> <a class="waves-effect waves-dark lbl3" href="{{url('caregiver')}}" aria-expanded="false"><img src="{{ asset('public/icons/image/heart1.png')}}" alt="" class="sideicon"><span class="hide-menu"> Caregivers</span></a>
                         ...
                         <li> <a class="waves-effect waves-dark lbl3" href="#" aria-expanded="false"><img src="{{ asset('public/icons/image/bar.png')}}" alt="" class="sideicon"><span class="hide-menu"> Referrals</span></a>
                           
                        </li>
                       
                         <li> <a class="waves-effect waves-dark lbl3" href="#" aria-expanded="false"><img src="{{ asset('public/icons/image/gear.png')}}" alt="" class="sideicon"><span class="hide-menu"> Reports</span></a>

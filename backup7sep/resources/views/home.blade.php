            ...
            <div class="col-lg-8 col-xlg-9">
                <div class="card">
                    ...
                    <div class="bg-light p-20">
                        ...
                        <div class="">
                            <input type="search" class="iptx form-control" placeholder="Missed checked in" name="search">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover earning-box">
                                ...
                                <tbody>
                                   <tr>
                                    <td style="width:50px;"><span class="round"><img src="public/assets/images/users/8.jpg" alt="user" width="50"></span><br><br></td>
                                    <td>
                                        <h6>Grant Marshal</h6><small class="text-muted">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</small><br><br><small class="text-muted">6 min ago</small></td>
                                        <td><small class="text-muted">12/12/2020 <br><br><br><br></small></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50px;"><span class="round"><img src="public/assets/images/users/8.jpg" alt="user" width="50"></span><br><br></td>
                                        <td>
                                    ...
                                    <div class="d-flex">
                                        <div class="m-r-20 align-self-center">
                                           ...
                                           <div class="row">
                                                ...
                                                <a href=""><h6 class="term1 p-2"><img src="public/assets/images/doc.png" alt="notes" width="50"></h6> 
                                                </a>
                                                @endforeach
      ...
      <!--   <div class="card-body">
            <div class="table">
                <table class="table table-hover earning-box">
                    ...
                    <tbody id="myTable">
                      @foreach($dailycarelogs as $row) 
                      <tr class="active">
                        <td>
                            <span class="sm12 textclr1">{{$row->time}}</span>
                        </td>
                        <td><span>
                            @if($row->image)
                    ...
                    <td>
                        <h6 class="sm12 textclr1">{{$row->intake_name}}</h6><small class=" textclr1 sm12">{{$row->from}}</small></td>
                        <td><span class="sm12 textclr1">{{$row->description}}</span></td>
                        <td class="sm12 textclr1">...</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>

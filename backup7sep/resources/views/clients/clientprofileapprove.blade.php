                        ...
                        <div class="card">
                            <div class="card-body">
                               <h3>Refered by</h3>
                                ...
                                <center class="m-t-30"> <img src="{{url('public/clients/'.$referby->image)}}" class="img-circle" width="150" />
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('approveclient')}}" method="Post" class="form-horizontal form-material"  enctype="multipart/form-data">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="payroll">
                                            ...
                                            <div class="form-group ">
                                                <div class="col-sm-12">
                                                    <button class="btn btn-success">Approve Profile</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>

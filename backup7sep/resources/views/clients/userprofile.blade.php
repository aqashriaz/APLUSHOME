 ...
 <div class="col-md-8 center1">
   <div class="mt-5">
    <center>
      ...
      <div class="col-md-8 col-sm-12 col-xs-12">
      <input type="text" class="abcd1 form-control" placeholder="Male"  name="gender" value="" >
      </div>          
      </div>
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
    <input type="number" class="abcd1 form-control" placeholder="+1254811564"  name="phone" value="" >
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
    <input type="text" class="abcd1 form-control" placeholder="2121 jhaj 464 465asa london"  name="address" value="" >

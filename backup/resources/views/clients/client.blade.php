                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <td>
                                    ...
                                    <a href="{{url('client/'.$row->id.'/delete')}}" class="" onclick="return confirm('Are you sure you want to delete this quiz?')" title=""> <img src="public/images/remove.jpg" alt="view" class="img-circle" style="height: 20px"></a>
                                  </td>

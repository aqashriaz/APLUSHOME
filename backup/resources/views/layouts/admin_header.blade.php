                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="{{url('conversation/'.$row->intakeco_id)}}">
                                                 @if($row->image)
                                                <div class="user-img"> <img src="{{url('public/clients/'.$row->image)}}" alt="user" class="img-circle" style="width: 70px; height: 70px;"> <span class="profile-status online pull-right"></span> 
                                                </div>
                                                @else
